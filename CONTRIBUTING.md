...
This outlines how to propose a change to qgisprocess. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("r-spatial/qgisprocess", fork = TRUE)`.
...
Code of
Conduct](https://r-spatial.github.io/qgisprocess/CODE_OF_CONDUCT.md). By
