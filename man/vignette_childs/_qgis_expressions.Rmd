...
This means that an algorithm argument that is usually a fixed value (numeric, distance, boolean, string or color) can _also_ take on the value of another field or the result of an expression.
