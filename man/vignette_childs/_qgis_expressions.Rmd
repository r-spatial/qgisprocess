...
Referring to the `INPUT` geometry is done with the `@geometry` variable.
...
Referring to the lake border geometry in an expression is a bit more tricky, since it requires several QGIS functions.
