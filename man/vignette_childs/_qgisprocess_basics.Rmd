For a very short introduction to **qgisprocess**, visit the GitHub landing page at <https://github.com/r-spatial/qgisprocess>.

Here you will learn about package configuration, about basic usage guided by two examples, and how to pipe results into a next geoprocessing step.
...
The output filepath be extracted with `qgis_extract_output()`.
