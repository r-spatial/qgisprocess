...
![](reference/figures/qgisprocess.svg)
...
Spatial layers can be passed to
[`qgis_run_algorithm()`](https://r-spatial.github.io/qgisprocess/reference/qgis_run_algorithm.md)
as file paths but also as [sf](https://r-spatial.github.io/sf/),
...
![](reference/figures/README-buffer-1.png)

### Some tips

You can search for algorithms with
...
A full list of available algorithms is returned by
...
![](reference/figures/copy_as_json.png)
