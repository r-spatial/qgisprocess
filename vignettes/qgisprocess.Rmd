...
Just printing the info objects shows which output objects have been made:

```{r info}
info
```

Then combine these output rasters as a multi-layered `SpatRaster` object and plot it:
