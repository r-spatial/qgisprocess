...
Additional functions are available to discover available geoprocessing algorithms, retrieve their documentation, handle processing results, manage QGIS plugins, and more.

`qgis_run_algorithm()` accepts as spatial input a file path to a spatial object stored on disk but also [sf](https://r-spatial.github.io/sf), [stars](https://r-spatial.github.io/stars), [terra](https://rspatial.github.io/terra) and [raster](https://cran.r-project.org/package=raster) objects.
