...
Please note that the qgisprocess project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
